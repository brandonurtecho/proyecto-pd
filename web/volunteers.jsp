            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="p-2 text-white" style="font-size: 24px;" href="/proyecto/principal/">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="p-2 text-white" style="font-size: 24px;" href="/proyecto/principal/eventos">Eventos</a>
                    </li>
                    <li class="nav-item">
                        <a class="p-2 text-white" style="font-size: 24px;" href="/proyecto/principal/disciplinas?num=0">Disciplinas Panamericanas</a>
                    </li>
                    <li class="nav-item">
                        <a class="p-2 text-white" style="font-size: 24px;" href="/proyecto/principal/disciplinas?num=1">Disciplinas Parapanamericanas</a>
                    </li>
                </ul>
            </div>
        </nav>
