...
public class TypeSport {
    ...
    public final static String BALONCESTO_SILLA_RUEDAS = "BALONCESTO EN SILLA DE RUEDAS";
    public final static String BOCCIA = "BOCCIA";
    public final static String FUTBOL_5 = "FUTBOL 5";
}
